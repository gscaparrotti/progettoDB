...
--
-- Host: localhost
-- Creato il: Giu 18, 2017 alle 12:19
...
(1, 'a@b.it', '2017-06-07 13:07:57', 6, 'Nuovo'),
(4, 'gscaparrotti@gmail.com', '2017-05-22 15:54:04', 1, 'Nuovo'),
(53, 'a@b.it', '2017-06-18 12:15:06', 6, 'Nuovo');
...
CREATE TABLE `Fornitore` (
  ...
  `Ragionesociale` text COLLATE utf8_bin NOT NULL,
  `CAP` int(5) NOT NULL,
  `Citta` text COLLATE utf8_bin NOT NULL,
  `Via` text COLLATE utf8_bin NOT NULL,
  `Civico` int(5) NOT NULL
...
INSERT INTO `Fornitore` (`PIVA`, `Ragionesociale`, `CAP`, `Citta`, `Via`, `Civico`) VALUES
...
(1111111111, '2017-06-18 12:05:58'),
...
CREATE TABLE `MetodoPagamento` (
  ...
  `Codice` varchar(16) COLLATE utf8_bin DEFAULT NULL,
...
(1, 'gscaparrotti@gmail.com', 'Giacomo Scaparrotti', 0, NULL, NULL, NULL),
(3, 'gscaparrotti@gmail.com', 'Giacomo Scaparrotti', 1, '1234567890123456', '10-17', 123),
(6, 'a@b.it', 'a@b.it', 1, '1', '11-20', 1);
...
--
-- Dump dei dati per la tabella `Ordinare`
--

INSERT INTO `Ordinare` (`Fornitore`, `Data`, `Prodotto`, `Quantita`) VALUES
(1111111111, '2017-05-19 11:50:56', 2, 1),
(1111111111, '2017-05-19 11:50:56', 4, 1),
(1111111111, '2017-06-18 12:05:58', 4, 1),
(1234567890, '2017-05-19 11:32:02', 1, 2),
(1234567890, '2017-05-19 11:33:36', 1, 1);
...
(3, '20', 'Ricevitore Bluetooth: Ascolta i brani dal tuo smartphone direttamente sull''impianto di casa!', 'Philips', 'Bluetooth Receiver', 'pictures/bluetooth.jpg', 3, 0, 'NULL', 0, 0, 0, 'Bluetooth', 'N/A', 'RCA Stereo'),
(4, '150', 'Altoparlanti ideali per applicazioni Home Theater!', 'Indiana Line', 'HC505', 'pictures/casse.jpg', 2, 0, 'NULL', 0, 50, 3, 'NULL', 'NULL', 'NULL');
...
(1, 1, 1234567890, '2017-05-19 11:32:02', 2, 0, 'Nuovo', 1),
(2, 1, 1234567890, '2017-05-19 11:33:36', 2, 20, 'Usato', 0),
(3, 2, 1111111111, '2017-05-19 11:50:56', 2, 0, 'Nuovo', 0),
(4, 2, 1111111111, '2017-05-19 11:50:56', 2, 0, 'Nuovo', 1),
(5, 1, 1234567890, '2017-05-19 11:32:02', 2, 0, 'Nuovo', 0),
(51, 4, 1111111111, '2017-06-18 12:05:58', 2, 0, 'Nuovo', 0),
(53, 4, 1111111111, '2017-05-19 11:50:56', 2, 20, 'Usato', 1);
...
--
-- Dump dei dati per la tabella `Ricambio`
--

INSERT INTO `Ricambio` (`Nome`, `Costo`) VALUES
('Scheda Elettronica', '50');
...
--
-- Dump dei dati per la tabella `Riparatore`
--

INSERT INTO `Riparatore` (`Matricola`, `Nome`, `Cognome`, `PagaOraria`) VALUES
(1, 'Giacomo', 'Scaparrotti', '10');
...
INSERT INTO `Riparazione` (`Prodotto`, `Cliente`, `Data Acquisto`, `Data`, `Durata`, `Riparatore`) VALUES
(4, 'gscaparrotti@gmail.com', '2017-05-22 15:54:04', '2017-05-27 19:57:07', 5, 1);
...
--
-- Dump dei dati per la tabella `Sostituzione`
--

INSERT INTO `Sostituzione` (`Prodotto`, `Cliente`, `Data Acquisto`, `Data`, `Ricambio`, `Quantita`) VALUES
(4, 'gscaparrotti@gmail.com', '2017-05-22 15:54:04', '2017-05-27 19:57:07', 'Scheda Elettronica', 1);
...
ALTER TABLE `Ordinare`
  ...
  ADD KEY `Ordinare_ibfk_2` (`Prodotto`);
...
--
ALTER TABLE `Fornitura`
  ADD CONSTRAINT `Fornitura_ibfk_1` FOREIGN KEY (`Fornitore`) REFERENCES `Fornitore` (`PIVA`);
...
ALTER TABLE `Ordinare`
  ...
  ADD CONSTRAINT `Ordinare_ibfk_2` FOREIGN KEY (`Prodotto`) REFERENCES `Prodotto` (`Codice`);
